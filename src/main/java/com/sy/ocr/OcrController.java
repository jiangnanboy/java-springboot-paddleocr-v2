...
public class OcrController {
    ...
    public void ocrImage(@RequestPart MultipartFile multipartFile, HttpServletResponse response) {
        ...
        try {
            ...
            List<OCRPredictResult> ocrEntries = ocrService.ocr(tFile.toURI().getPath().replaceFirst("/", ""));
    ...
    public String ocr(@RequestPart MultipartFile multipartFile) {
        File tFile = null;
        List<OCRPredictResult> ocrEntries = null;
        try {
            tFile = multipartFiletoFile(multipartFile);
        ...
        return JSON.toJSONString(ocrEntries);
    }
